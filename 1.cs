...
namespace LatihanInheritance
{
    class Program
    {
        ...
        {
            Person person = new Person("Nugroho", 19);
            person.GetNameAndAge();

            Teacher teacher = new Teacher("Kamarudin", 36, "158345", "Pemrograman");
            teacher.GetNameAndAge();

            Student student = new Student("Wahyu Nugroho", 18, "19.11.2741", "wahyu.2001@students.amikom.ac.id");
